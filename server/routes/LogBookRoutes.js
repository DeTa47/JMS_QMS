...
const {getLogbooks, createLogBook, createLogBookById, getMonthlyLogbooks, getLogbookdata, insertValues, updateValues, archivelogbook} = require('../controllers/LogBookController');
...
router.patch('/archivelogbook', archivelogbook);
