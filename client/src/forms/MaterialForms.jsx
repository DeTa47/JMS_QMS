    ...
    return (
        <Modal onClose={() => setmaterialform(false)}>
            <div className="max-w-lg mx-auto p-6 bg-white rounded shadow-md">
                <form
                    aria-label="Material data input form"
                    className="space-y-4"
                ...
                >
                    ...
                    <div className="flex justify-between">
                        <button
                            type="button"
                            onClick={handleSave}
                            className="w-1/3 p-2 bg-blue-500 text-white rounded hover:bg-blue-600 cursor-pointer"
                        >
                            Save
                        </button>
                        <button
                            ...
                            className="w-1/3 p-2 bg-red-500 text-white rounded hover:bg-red-600 cursor-pointer"
                        >
                            Close
                        </button>
                    </div>
